...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right,rgb(139, 189, 230), #cfdef3);
...
<body>
    <div class="login-result">
        ...
        <?php if ($isValid): ?>
            ...
            <a href="bai21_mainpage.php"><button>Trang chính</button></a>
        <?php else: ?>
            <p>❌ Thông tin đăng nhập không hợp lệ!</p>
            <a href="bai21_login.html"><button>Quay lại</button></a>
        <?php endif; ?>
    </div>
</body>
</html>